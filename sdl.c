...
int sdl_init (void)
{
    ...
    window = SDL_CreateWindow("Spang!", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 1280, screen_height, SDL_WINDOW_FULLSCREEN);
    ...
    if (SDL_RenderSetScale(renderer, 2, 1) != 0)
    {
    	fprintf (stderr, "Error creating render scale: %s\n", SDL_GetError());
    }
